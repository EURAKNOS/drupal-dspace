...
/**
 * Provides an interface defining an Dspace entity type entity.
 */
interface DspaceEntityTypeInterface extends ConfigEntityInterface {
   ...
   *
   * @return string|null
   *   The Dspace entity types description, or NULL if empty.
   */
  public function getDescription();

  /**
   * Returns if entities of this Dspace entity are read only.
   *
   * @return bool
   ...
   *   DspaceEntityTypeInterface::getFieldMapping().
   */
   ...
   *   while 0 means entity caching for this Dspace entity type is disabled.
   */
  ...
  /**
   * Returns whether the Dspace entity can be annotated.
   *
   * @return bool
  ...
  /**
   * Returns if the Dspace entity inherits its annotation entities fields.
   *
   * @return bool
  ...
  /**
   * Returns the base path for these dspace entities.
   *
