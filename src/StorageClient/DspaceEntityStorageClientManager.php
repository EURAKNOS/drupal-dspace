...
/**
 * DspaceEntityStorageClient plugin manager.
 */
class DspaceEntityStorageClientManager extends DefaultPluginManager {

  /**
   * Constructs an DspaceEntityStorageClientManager object.
   *
